...
st.sidebar.markdown(
    "<br> <br> <br> <br> <br> <br> <h1 style='text-align: center; font-size: 18px; color: #0080FF;'>© 2023 | ppn</h1>", unsafe_allow_html=True)
...
if button_predict:
    ...
    # 4. display
        ...
        #     st.info(
        #         "From Cleaned text has removed stopwords and transformed to lowercase. Also, it has be used Stemming!")
